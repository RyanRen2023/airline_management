...
class AirplaneDetailView extends StatefulWidget {
  ...
  void updateAirplanes() {
    ...
    Airplane oldAirplane = this.airplane;
    String airplaneType = _airplaneTypeController.value.text;
    String numberOfPassengers = _numberOfPassengersController.value.text;
    String maxSpeed = _maxSpeedController.value.text;
    String rangeToFly = _rangeToFlyController.value.text;
  ...
  Widget build(BuildContext context) {
    ...
    _airplaneTypeController.text = selectedAirplane.airplaneType!;
    _numberOfPassengersController.text = selectedAirplane.numberOfPassengers! as String;
    _maxSpeedController.text = selectedAirplane.maxSpeed as String;
    _rangeToFlyController.text = selectedAirplane.rangeToFly as String;
